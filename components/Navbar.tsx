        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-5">
              ...
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 8px 30px rgba(217,119,6,0.4)" }}
                whileTap={{ scale: 0.97 }}
            ...
            <div className="absolute right-0 top-0 bottom-0 w-72 bg-surface flex flex-col pt-24 pb-8 px-8 border-l border-white/10">
              {navLinks.map((link, i) => (
                <motion.button
                  ...
                  onClick={() => scrollTo(link.href)}
                  className={`text-left py-4 font-playfair text-xl border-b border-white/8 transition-colors duration-300 ${
                    activeSection === link.href.slice(1)
                      ? "text-primary"
