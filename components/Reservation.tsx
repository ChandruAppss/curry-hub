...
import { CheckCircle, Calendar, Clock, Users, User, Phone, Mail, MessageSquare } from "lucide-react";
...
function FloatingInput({
  ...
  return (
    <div className="relative">
      ...
      {error && (
        <p className="mt-1 text-xs text-red-400 pl-4">{error}</p>
      )}
    </div>
  );
}
...
export default function Reservation() {
  ...
  return (
    ...
    >
      {/* Background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(217,119,6,0.07)_0%,transparent_70%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/60 leading-relaxed mb-8">
              Join us for an unforgettable Indian dining experience. Whether
              it's an intimate dinner for two, a family feast, or a corporate
              celebration — we'll make your evening exceptional.
            </p>
            ...
            <div className="mt-10 p-6 rounded-2xl border border-primary/20 bg-primary/5">
              ...
              <p className="text-white/60 text-sm">
                We cater to birthdays, anniversaries, and corporate events.
                Mention your occasion in the message field — we'll make it
                unforgettable.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-dark rounded-2xl p-8 lg:p-10 shadow-2xl">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-white/50 text-sm">
                      ...
                      <span className="text-white/70">{form.phone}</span> within
                      30 minutes.
                    </p>
                    <button
                      onClick={() => {
                      ...
                      className="mt-8 px-6 py-3 border border-primary/40 text-primary text-sm rounded-full hover:bg-primary hover:text-black transition-all duration-300"
                    >
                  ...
                  >
                        ...
                        >
                          <Clock
                            className={`absolute left-4 w-4 h-4 transition-colors ${
                              form.time ? "text-primary" : "text-white/30"
                            }`}
                          />
                          <select
                            value={form.time}
                          ...
                          >
                            Time<span className="text-primary ml-0.5">*</span>
                          </label>
                        </div>
                        {errors.time && (
                      ...
                      >
                        <MessageSquare
                          className={`absolute left-4 top-4 w-4 h-4 transition-colors ${
                            form.message ? "text-primary" : "text-white/30"
                          }`}
                        />
                        <textarea
                          value={form.message}
                          ...
                          className="w-full pl-11 pr-4 pt-4 pb-3 bg-transparent text-white text-sm focus:outline-none resize-none placeholder:text-white/30"
                        />
                      </div>
                    </div>
                    ...
                    <motion.button
                      ...
                      className="w-full py-4 bg-gold-gradient text-black font-semibold rounded-xl text-base hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {loading ? (
